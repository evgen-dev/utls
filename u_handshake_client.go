...
import (
	...
	"github.com/evgen-dev/utls/internal/fips140tls"
	"github.com/evgen-dev/utls/internal/hpke"
...
func (c *UConn) echTranscriptMsg(outer *clientHelloMsg, echCtx *echClientContext) (err error) {
	...
	// See https://github.com/evgen-dev/utls/blob/e430876b1d82fdf582efc57f3992d448e7ab3d8a/ech.go#L276-L283
