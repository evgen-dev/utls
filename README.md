...
[![Build Status](https://github.com/evgen-dev/utls/actions/workflows/go.yml/badge.svg?branch=master)](https://github.com/evgen-dev/utls/actions/workflows/go.yml) 
...
It LGTM, but please open up Wireshark and check. If you see something — [say something](https://github.com/evgen-dev/utls/issues).
...
There sure are. If you found one that approaches practicality at line speed — [please tell us](https://github.com/evgen-dev/utls/issues).
...
1. Import this library (e.g. `import tls "github.com/evgen-dev/utls"`)
